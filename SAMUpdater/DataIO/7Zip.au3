...
Global $sZip64Dll = "7-zip32.dll" 			;|to modify _7ZipStartup() function in FileInstall section.
...
Func _7ZipStartup()
	If Not @Compiled Then ; If not compiled, test and open the right dll
		If Not FileExists($sNoCompiledPath & $sZip32Dll) Then Return SetError(2, 0, 0)
...
Func _7ZipShutdown()
	...
	If @Compiled Then
		If Not  FileDelete($sCompiledPath & $sZip32Dll) Then Return SetError(1, 0, 0)
	EndIf
	Return 1
